...
public class BytePatternMatcher {
     ...
     * Creating object using this constructor will initialize all the class variables to their default values.
     */
    ...
    /**
     * Searches for pattern/patterns after user has selected a file or directory along with the pattern file that contains patterns to be searched.
     *
     * @return Returns a TreeMap with Integer that represents offset of the matched pattern as a key and a byte[] containing the matched pattern as the value.
     */
    ...
    /**
     * Sets/Updates the source file.
     * This function will set/update the currently selected file to search for pattern/patterns with the file passed to it.
     *
    ...
    /**
     * Sets/Updates the source directory.
     * This function will set/update the currently selected directory to search for pattern/patterns with the file passed to it.
     *
    ...
    /**
     * Sets/Updates the pattern file.
     * This function will set/update the currently selected pattern file containing the patterns list with the file passed to it.
     *
     * @param file The file selected by the user.
    ...
    /**
     * Sets/Updates the flag.
     * This function will set/update the flag for the application to determine if the user has selected a file or a directory.
     *
     * @param isSelected A boolean value that represents whether user selected a file or a directory.
     */
     ...
     *
     * @return Returns a TreeMap with String that represents the file name of the source as key, and a value of TreeMap of matched patterns with Integer that represents offset of the matched pattern as a key and a byte[] containing the matched pattern as the value.
     */
    ...
    /**
     * Gets the flag for the selected state of directory or file.
     *
     * @return Returns a boolean value that represents whether the user has selected a file or a directory.
     */
     ...
     *
     * @param source      A TreeMap of String as the file name, and an ArrayList of Byte that represents the bytes of the contents inside file.
     * @param patternList An ArrayList of byte[] containing the pattern/patterns to be within the source.
     * @return Returns a TreeMap with Integer representing the offset of the matched pattern as key and, a byte[] of pattern matched at that offset as value.
     */
     ...
     * @param patternList An ArrayList of byte[] containing the pattern/patterns to be matched within the source.
     * @return Returns a TreeMap with Integer representing the offset of the matched pattern as key and, a byte[] of pattern matched at that offset as value.
     */
    ...
    /**
     * Provides the index of pattern/patterns matched given a source and pattern list.
     * This is the core function that encapsulates the byte pattern searching algorithm.
     *
     * @param source  An ArrayList of Byte that represents the bytes of the contents inside file.
        ...
        if (patternLength != 0) {
            ...
            for (int index = 0; index < sourceLength; index++) {
                ...
                if (source.get(index) == pattern[patternLoopIndex]) {
                    ...
                    // ... Re-iterate from the start of the pattern if in any point during the loop the sequence of the source bytes doesn't match the pattern's byte sequence.
                ...
                // ... Store the results once the byte sequence from the source fully matches the pattern's byte sequence.
    ...
    /**
     * Reads a file.
     * This function reads source file as bytes and stores them into fileBytes.
     *
     * @param file The source file to be read.
     * @return Returns an ArrayList of Byte generated after reading the file passed to it.
    ...
    /**
     * Reads a directory.
     * This function reads a directory containing multiple source files.
     *
     * @param dir The file containing multiple source files.
     * @return Returns a TreeMap with String that represents the file name inside directory as key, and an ArrayList of Byte that represents the bytes of content within the file as value.
     * @throws IOException Throws an {@link IOException} if the file passed to it is invalid.
     */
     ...
     * This function reads a pattern file containing pattern/patterns to be searched.
     *
    ...
    /**
     * Gets a byte array given a hexadecimal string.
     * This function converts a hexadecimal string to return a byte array.
     *
     ...
     * This function converts a string[] representing hexadecimal numbers to a byte array.
     *
