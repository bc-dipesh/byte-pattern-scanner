...
public class AppView extends JFrame {
	...
	/**
	 * Provides mechanism to add ActionListener to menu item load from a file. Use
	 * this function to add the controller's ActionListener for listening to events
	 * when user selects menu item load from a file from the file menu.
	 *
	 * @param menuItemLoadFromFileListener The Controller's ActionListener to listen
	 *                                     to events from the menu item load from a
	 *                                     file.
	 */
	 ...
	 * Use this function to add the controller's ActionListener for listening to
	 * events when user selects menu item load from a directory from the file menu.
	 *
	 * @param menuItemLoadFromDirListener The Controller's ActionListener object to
	 *                                    listen to events from the menu item load
	 *                                    from a directory.
	 */
	...
	/**
	 * Provides mechanism to add ActionListener to menu item about. Use this
	 * function to add the controller's ActionListener for listening to events when
	 * user selects menu item about from the file menu.
	 *
	 * @param menuItemAboutListener The Controller's ActionListener object to listen
	 *                              to events from the menu item about.
	 */
	...
	/**
	 * Provides mechanism to add ActionListener to menu item exit. Use this function
	 * to add the controller's ActionListener for listening to events when user
	 * selects menu item exit from the file menu.
	 *
	 * @param menuItemExitListener The Controller's ActionListener object to listen
	 *                             to events from the menu item exit.
	 */
	...
	/**
	 * Provides mechanism to add ActionListener to load data from file button. Use
	 * this function to add the controller's ActionListener for listening to events
	 * when user presses load data from file button.
	 *
	 * @param loadDataFromFileBtnListener The Controller's ActionListener object to
	 *                                    listen to events from load data from file
	 *                                    button.
	 */
	 ...
	 * Use this function to add the controller's ActionListener for listening to
	 * events when user presses load data from directory button.
	 *
	 * @param loadDataFromDirBtnListener The Controller's ActionListener object to
	 *                                   listen to events from load data from
	 *                                   directory button.
	 */
	...
	/**
	 * Provides mechanism to add ActionListener to load pattern button. Use this
	 * function to add the controller's ActionListener for listening to events when
	 * user presses load pattern button.
	 *
	 * @param loadPatternBtnListener The Controller's ActionListener object to
	 *                               listen to events from load pattern button.
	 */
	...
	/**
	 * Provides mechanism to add ActionListener to search pattern button. Use this
	 * function to add the controller's ActionListener for listening to events when
	 * user presses search pattern button.
	 *
	 * @param searchPatternBtnListener The Controller's ActionListener object to
	 *                                 listen to events from search pattern button.
	 */
	...
	/**
	 * Sets/updates load data from file label. This function sets/updates the name
	 * of the file to be scanned in load data from file label with the string passed
	 * to it.
	 *
	...
	/**
	 * Sets/updates load data from directory label. This function sets/updates the
	 * name of the directory to be scanned in load data from directory label with
	 * the string passed to it.
	 *
	 * @param dirName The directory name to set/update in load data from directory
	 *                label.
	 */
	...
	/**
	 * Sets/updates the load pattern label. This function sets/updates the name of
	 * the pattern file containing the pattern/patterns to be searched in load
	 * pattern label with the string passed to it.
	 *
	...
	/**
	 * Sets/updates the search results text area. This function sets/updates the
	 * text area with the results passed to it.
	 *
	 * @param result The string containing results generated after searching for
	 *               pattern/patterns.
	 */
